...
export class Root extends jspb.Message {
  ...
  hasChangecounter(): boolean;
  clearChangecounter(): void;
  getChangecounter(): number | undefined;
  setChangecounter(value: number): void;
...
export class Section extends jspb.Message {
  clearPageidxsList(): void;
  getPageidxsList(): Array<number>;
  setPageidxsList(value: Array<number>): void;
  addPageidxs(value: number, index?: number): number;
